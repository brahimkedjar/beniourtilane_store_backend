...
const bus_simulation_service_1 = require("./bus-simulation.service");
...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, operators_module_1.OperatorsModule, auth_module_1.AuthModule],
        providers: [realtime_gateway_1.RealtimeGateway, bus_simulation_service_1.BusSimulationService],
